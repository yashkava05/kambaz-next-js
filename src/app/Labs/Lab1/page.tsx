...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <h2>Source Code</h2>
      <ul>
        <li><a href="https://github.com/yashkava05/kambaz-next-js" id="wd-github" target="_blank">GitHub Repository</a></li>
      </ul>
      ...
      <div id="wd-forms" style={{ marginTop: 16 }}>
        ...
        <form id="wd-text-fields">
          ...
          <input id="wd-text-fields-username" type="text" defaultValue="yashKava" /><br />

          <label htmlFor="wd-text-fields-password">Password:</label><br />
          <input id="wd-text-fields-password" type="password" defaultValue="haha123" /><br />

          <label htmlFor="wd-text-fields-first-name">First name:</label><br />
          <input id="wd-text-fields-first-name" type="text" defaultValue="Yash" /><br />

          <label htmlFor="wd-text-fields-last-name">Last name:</label><br />
          <input id="wd-text-fields-last-name" type="text" defaultValue="Kava" /><br />

          <h5>Text boxes</h5>
          <label>Biography:</label><br />
          <textarea id="wd-textarea" cols={40} rows={6} defaultValue="Assignment One Completed!" />
          ...
          <input type="email" id="wd-text-fields-email" placeholder="abcd@email.com" defaultValue="yash@email.com" /><br />
      ...
      <div id="wd-links" style={{ marginTop: 16 }}>
        ...
        <a id="wd-github" href="https://github.com/yashkava05/kambaz-next-js" target="_blank" rel="noreferrer">GitHub Repo Link</a>
      </div>
    </div>
    </div>
  )
